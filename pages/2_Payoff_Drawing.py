"""
Payoff Drawing — Reconnaissance de structure par dessin
"""
...
from utils import (inject_css, render_sidebar, render_footer, bs_price,
                   ...
                   RED, MUTED, AMBER, TL, TC, CANVAS_W, CANVAS_H)
import warnings
warnings.filterwarnings('ignore')

st.set_page_config(page_title="Payoff Drawing — Payoff Builder", layout="centered",
